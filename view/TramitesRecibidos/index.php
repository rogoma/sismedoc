        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                <a style="float:left;width:220px;height:40px;padding: 6px;" target="_blank" class="btn btn-flat bg-gradient-primary" id="NuevoPDF">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button style="height: 40px;width: 150px;" type="button" class="btn btn-primary" id="derivar">Derivar</button>
              <button style="height: 40px;width: 150px;" type="button" class="btn btn-primary" id="finalizar">Archivar</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <ol style="width: 160px" class="breadcrumb float-sm-right">
            <li style="font-weight:600"><i class="nav-icon fas fa-file-download"></i>&nbsp;Trámites Recibidos</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-12">
              ...
              <div class="card card-danger card-outline">
                <div class="card-header ">
                  <h3 class="card-title" style="font-weight:600; color:#084B8A">Listado de Trámites Recibidos</h3>
                ...
                <table id="tablaTRecibidos" class="table table-hover" style="width:100%" >
