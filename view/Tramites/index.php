...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/sismedoc/public/assets/plugins/jquery-ui-1.13.1.custom/jquery-ui.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- MODAL DATOS DE INSTITUCION-->
      <div class="modal fade" id="modalinsti">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" id="modal-header">
              <h4 class="modal-title" id="modal-title">Datos de la Institución</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <form id="formarea">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="icod" id="icod"/>
                        </div>
...
<div class="modal fade" id="modalinstitu">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-1">
          ...
          <ol style="width: 110px" class="breadcrumb float-sm-right">
            <li style="font-weight:600"><i class="nav-icon fas fa-file-medical"></i>&nbsp;Trámites</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-12">
              ...
              <div class="card card-danger card-outline">
                ...
                <div class="card-body">
                  ...
                  <table id="tablaTramites" class="table table-hover" style="width:100%" >
  ...
  <script src="/sismedoc/public/assets/plugins/jquery-ui-1.13.1.custom/jquery-ui.js"></script>
  <script src="/sismedoc/public/assets/plugins/jquery-ui-1.13.1.custom/datepicker-es.js"></script>
