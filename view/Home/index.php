              ...
              <div class="row">
                <div class="col-md-4 col-sm-6 col-12">
                  <div class="info-box bg-danger">
                    <span class="info-box-icon bg-danger"><img src="/sismedoc/public/assets/img/rechazado.png"></span>
                ...
                <div class="col-md-4 col-sm-6 col-12">
                  <div class="info-box bg-primary">
                    <span class="info-box-icon bg-primary"><img src="/sismedoc/public/assets/img/pendiente.png"></span>
                    <div class="info-box-content">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                  <div class="info-box bg-green">
                    <span class="info-box-icon bg-green"><img src="/sismedoc/public/assets/img/documentos.png"></span>
                    <div class="info-box-content">
